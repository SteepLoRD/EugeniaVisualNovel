...
define config.name = _("EugeniaDemo")
...
define config.version = "0.0.3 (Build ??-??-2021/Test)"
...
define gui.about = _p("""
    Автор идеи — SteepLoRD
    
    Художники — Space, Fraynivayni
    
    ВНИМАНИЕ! Контент, присутствующий в данной версии игры, может быть изменён/удалён в дальнейшем!
""")
...
define config.save_directory = "EugeniaDemo-1631238680"
